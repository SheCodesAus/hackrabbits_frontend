...
function ProfilePage() {
  ...
  console.log(":mag: Params object:", params); // Debugging
  const rolemodelId = params.id;
  console.log(":mag: Extracted rolemodelId from useParams:", rolemodelId); // Debugging
  if (!rolemodelId) {
    console.error(
      ":rotating_light: Error: rolemodelId is undefined! Check router setup."
    );
